  ...
  const analyzeImage = async (file: File): Promise<Partial<ClothingItem>> => {
    try {
      ...
      if (
        ...
        fileName.includes("blouse") ||
        fileName.includes("sweater")
      ) {
        category = "tops";
      } else if (
        fileName.includes("pant") ||
        fileName.includes("jean") ||
        fileName.includes("trouser") ||
        ...
        fileName.includes("blazer")
      ) {
        category = "outerwear";
        season = ["fall", "winter"];
      } else if (
        fileName.includes("shoe") ||
        fileName.includes("sneaker") ||
        fileName.includes("boot") ||
        fileName.includes("sandal")
      ) {
        category = "shoes";
      } else if (
        fileName.includes("bag") ||
        fileName.includes("hat") ||
        fileName.includes("scarf") ||
        fileName.includes("belt")
      ) {
          ...
          <CardContent className="p-8">
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                {isAnalyzing
                  ? "Please wait while we categorize and tag your items"
                  : "Drag & drop photos or click to browse (supports batch upload)"}
              </p>
              <Button
                ...
                <Dialog key={item.id}>
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Customize the AI-generated tags and add additional
                        information
                      </DialogDescription>
                    </DialogHeader>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <Select
                            value={item.style}
                            onValueChange={(value) =>
                              updateItem(item.id, { style: value })
                            }
                          >
                            <SelectTrigger>
                              <SelectValue />
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {occasions.map((occasion) => (
                              <Badge
                                ...
                                onClick={() => {
                                  const newOccasions = item.occasion.includes(
                                    occasion,
                                  )
        ...
        {items.length === 0 && !isAnalyzing && (
          <Card className="text-center py-12 shadow-card">
            <CardContent>
              ...
              <h3 className="text-xl font-semibold mb-2">
                Ready to upload your wardrobe?
              </h3>
              <p className="text-muted-foreground mb-4">
                Start by uploading photos of your clothes. Our AI will
                automatically categorize and tag them for you.
              </p>
