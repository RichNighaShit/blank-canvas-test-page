...
const StyleRecommendations = () => {
  ...
  if (authLoading || profileLoading) {
    return (
      <>
        <SEOHead 
          title="Loading Style Recommendations"
          noIndex={true}
        />
  ...
  return (
    <>
      <SEOHead 
        title="AI Style Recommendations - Personalized Fashion Advice"
        description="Get personalized outfit recommendations, plan your weekly looks, and discover smart shopping suggestions with DripMuse's AI styling assistant."
        keywords="style recommendations, AI outfit suggestions, fashion advice, outfit planner, smart shopping, personal styling"
        url="https://dripmuse.com/recommendations"
            ...
            <div className="max-w-7xl mx-auto">
              <Tabs defaultValue="outfits" className="space-y-12">
                ...
                <TabsContent value="outfits" className="space-y-8">
                  <section className="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border border-purple-100 dark:border-purple-800/50 shadow-2xl shadow-purple-500/10">
                ...
                <TabsContent value="planner" className="space-y-8">
                  <section className="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border border-blue-100 dark:border-blue-800/50 shadow-2xl shadow-blue-500/10">
                ...
                <TabsContent value="shopping" className="space-y-8">
                  <section className="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border border-emerald-100 dark:border-emerald-800/50 shadow-2xl shadow-emerald-500/10">
