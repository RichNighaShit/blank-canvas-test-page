        ...
        <div className="flex items-center space-x-4">
          ...
          {isMobile && (
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[320px] bg-background/95 backdrop-blur-md">
                <div className="flex flex-col space-y-6 mt-8">
                  ...
                  {!user && (
                    <>
                      <hr className="border-border/50 my-4" />
                      <Button variant="ghost" size="lg" onClick={() => { handleSignIn(); setMobileMenuOpen(false); }}>
                        Sign In
                      </Button>
                      <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700" onClick={() => { handleGetStarted(); setMobileMenuOpen(false); }}>
                        Get Started
                      </Button>
                    </>
                  )}
          ...
          {!isMobile && user && (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 bg-background/95 backdrop-blur-md" align="end">
                ...
                <DropdownMenuItem onClick={() => navigate('/edit-profile')} className="py-3">
          ...
          {!isMobile && !user && (
            <>
              ...
              <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-button" onClick={handleGetStarted}>
                Get Started
              </Button>
            </>
          )}
